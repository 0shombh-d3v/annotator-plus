...
- Removed Open File, Presentation Mode, and Current Page from Tools while keeping navigation, rotation, cursor, scrolling, spread, and document-property controls.
...
- Kept PDF Print, Save, and Tools actions available.
