...
The 0.4.8 reader stack is reproducibly pinned to PDF.js 6.2.108, Hypothesis client commit `b4d085a2f893aa6de3b61d8b8bc3ae4d0f24fc1a`, and Dark Reader 4.9.128. These are bundled locally; Annotator+ does not download executable code at runtime.
